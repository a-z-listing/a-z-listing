...
class AZ_Shortcode_Grouping_Numbers_Before_Tests extends \Codeception\TestCase\WPTestCase {
    /**
     * @var \UnitTester
     */
    protected $tester;
	...
	public function testEmpty() {
		$expected = file_get_contents( 'tests/_data/default-listing-grouped-numbers-before.txt' );
	...
	public function testPopulatedListing() {
		...
		$expected = sprintf( file_get_contents( 'tests/_data/populated-listing-grouped-numbers-before.txt' ), $title, $url );
		$actual   = do_shortcode( '[a-z-listing grouping="3" numbers="before"]' );
	...
	public function testPopulatedTaxonomyListing() {
		...
		$expected = sprintf( file_get_contents( 'tests/_data/populated-taxonomy-listing-grouped-numbers-before.txt' ), $title, $url );
