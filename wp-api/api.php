<?php
function a_z_real_api_handler( WP_REST_Request $request, $args ) {
...
add_action( 'rest_api_init', function () {
	...
	register_rest_route( 'a-z-listing/v1', '/posts/(?P<post_type>[a-z0-9-]+)', array(
		'methods' => 'GET',
	...
	register_rest_route( 'a-z-listing/v1', '/terms/(?P<taxonomy>[a-z0-9-]+)', array(
		'methods' => 'GET',
